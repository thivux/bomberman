...
public class Sprite {
    ...
    private final SpriteSheet _sheet;
    ...
    public Image getImage() {
        return resample(_sheet.image.getSubimage(_x, _y, SIZE, SIZE), SCALED_SIZE / DEFAULT_SIZE);
    }

    private Image resample(BufferedImage input, int scaleFactor) {
        return input.getScaledInstance(input.getWidth() * scaleFactor, input.getHeight() * scaleFactor, BufferedImage.SCALE_DEFAULT);
    }
